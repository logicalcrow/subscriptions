...
class PlanSubscriptionSchedule extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('logicalcrow.tables.plan_subscription_schedules'));
    }
    ...
    {
        return [
            'subscription_id' => 'required|integer|exists:' . config('logicalcrow.tables.plan_subscriptions') . ',id',
            'scheduled_at' => 'date'
        ];
    }
    ...
    {
        return $this->belongsTo(config('logicalcrow.models.plan_subscription'), 'subscription_id', 'id');
    }
