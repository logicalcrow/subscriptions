...
class PlanSubscriptionUsage extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('logicalcrow.tables.plan_subscription_usage'));
    }
    ...
    {
        return [
            'plan_subscription_feature_id' => 'required|integer|exists:' . config('logicalcrow.tables.plan_features') . ',id',
    ...
    {
        return $this->belongsTo(config('logicalcrow.models.plan_subscription_feature'), 'plan_subscription_feature_id', 'id', 'feature');
    }
