...
use Logicalcrow\Subscriptions\Exceptions\DuplicateException;
...
use Logicalcrow\Subscriptions\Traits\HasSubscriptionPeriod;
use Logicalcrow\Subscriptions\Traits\HasTrialPeriod;
...
class Plan extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('logicalcrow.tables.plans'));
    }
    ...
    {
        return [
            'tag' => 'required|max:150|unique:' . config('logicalcrow.tables.plans') . ',tag',
    ...
    {
        return $this->hasMany(config('logicalcrow.models.plan_combination'), 'plan_id', 'id');
    }
    ...
    {
        return $this->hasMany(config('logicalcrow.models.plan_feature'), 'plan_id', 'id');
    }
    ...
    {
        return $this->hasMany(config('logicalcrow.models.plan_subscription'), 'plan_id', 'id');
    }
